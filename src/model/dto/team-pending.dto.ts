...
import { TeamPendingOptionalDefaultsSchema, TeamPendingPartialSchema, TeamPendingSchema } from "model/schema";

export class TeamPendingDto
  extends createZodDto(TeamPendingSchema) {}
