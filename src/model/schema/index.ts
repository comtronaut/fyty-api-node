...
export const EventScalarFieldEnumSchema = z.enum(['id','gameId','type','name','description','coverUrl','maxParticipantCount','isHidden','signupStartAt','signupEndAt','startAt','endAt','updatedAt','createdAt']);

export const EventRoundScalarFieldEnumSchema = z.enum(['id','eventId','startAt','endAt','updatedAt']);

export const EventParticipantScalarFieldEnumSchema = z.enum(['id','eventId','teamId','updatedAt','joinedAt']);
...
export const RoomScalarFieldEnumSchema = z.enum(['id','name','status','option','startAt','endAt','isPrivate','teamCount','note','gameId','hostTeamId','appointmentId','updatedAt','createdAt']);
