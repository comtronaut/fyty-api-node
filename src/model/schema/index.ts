...
export const TeamLineupScalarFieldEnumSchema = z.enum(['id','teamId','avatarId','inGameId','isDefault','profileUrl','imageUrl','name','note']);
...
export const TeamScalarFieldEnumSchema = z.enum(['id','name','coverUrl','logoUrl','tier','isPrivate','gameId','founderId','isDeleted','createdAt']);
...
export const TrainingScalarFieldEnumSchema = z.enum(['id','appointmentId','hostId','guestId','hostWinCount','hostLoseCount','note','status','imageUrls','isSubmitted','updatedAt','createdAt']);
...
export const TrainingStatusSchema = z.enum(['ACCEPTED','DENIED','INEFFECTIVE','UNREVIEWED']);
